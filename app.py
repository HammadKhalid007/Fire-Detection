...
class Home(QMainWindow):
    ...
    def camer1(self):
        ...
        widget3.setFixedWidth(int(width))
        widget3.setFixedHeight(int(height) + 10)
        widget3.addWidget(cam)
        widget3.setWindowTitle("Fire Detection")
        logo_icon = QIcon("logo.png")
        widget3.setWindowIcon(logo_icon)
    ...
    def emergency(self):
        ...
        widget2.setWindowTitle("Fire Detection")
        logo_icon = QIcon("logo.png")
        widget2.setWindowIcon(logo_icon)
    ...
    def alert1(self):
        ...
        b.setWindowTitle("Fire Detection")
        logo_icon = QIcon("logo.png")
        b.setWindowIcon(logo_icon)
...
class mainscreen(QMainWindow):
    def __init__(self):
        ...
        self.cap1 = cv2.VideoCapture('fire2.mp4')
        self.cap3 = cv2.VideoCapture('fire2.mp4')
        self.cap4 = cv2.VideoCapture('fire2.mp4')
...
class camera2(QMainWindow):
    def __init__(self):
        ...
        loadUi("extended.ui", self)
        self.playing = True
        self.cap = cv2.VideoCapture("fire2.mp4")
        self.width = self.cap.get(cv2.CAP_PROP_FRAME_WIDTH)
        self.height = self.cap.get(cv2.CAP_PROP_FRAME_HEIGHT)
        self.closeEvent = self.closeEventOverride
        self.timer = QTimer(self)
